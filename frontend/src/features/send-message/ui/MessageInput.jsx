...
function MessageInput({ onSend, onUpload, disabled }) {
  ...
  return (
    <form className="p-3 px-4 pb-safe-offset-4 bg-tg-bg anim-fade-in" onSubmit={handleSubmit}>
      ...
      <div className={`transition-all duration-200 ${isMobile && !message.trim() && !recording ? 'opacity-100 scale-100' : 'opacity-0 scale-95 pointer-events-none'}`}>
        {isMobile && (
          <button
            type="button"
      ...
      <div className={`transition-all duration-200 ${message.trim() ? 'opacity-100 scale-100' : 'opacity-0 scale-95 pointer-events-none'}`}>
        <button
          type="submit"
          disabled={disabled}
      ...
      {/* Recording indicator */}
      <div className={`transition-all duration-200 ${recording ? 'opacity-100 scale-100' : 'opacity-0 scale-95 pointer-events-none'}`}>
        <button
          type="button"
